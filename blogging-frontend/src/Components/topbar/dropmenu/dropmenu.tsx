...
export default function DropMenu({toggleMenu}:MyComponentProps) {
    return (
        <div className="fixed top-0 left-0 h-screen w-screen" onClick={toggleMenu}>
            <div className="fixed top-16 right-8 bg-zinc-500 p-5 text-xl rounded-md ring-1 ring-black"  onClick={e => e.stopPropagation()}>
                <div className="flex bg-zinc-600 p-1 rounded-lg mb-3 lg:hover:bg-zinc-700 lg:duration-1000">
                    ...
                    <p className="text-sm ml-1">account</p>
                </div>
                <div className="flex bg-zinc-600 p-1 rounded-lg mb-3 lg:hover:bg-zinc-700 lg:duration-1000">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                    ...
                    <p className="text-sm ml-1">settings</p>
                </div>
            </div>
        </div>
    )
