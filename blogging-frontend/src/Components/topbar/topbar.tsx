...
export default function Topbar() {
    ...
    return (
        <div className="h-fit w-screen bg-gray-300 rounded-3xl p-6 grid grid-cols-9 dark:bg-neutral-700">
            ...
            <div className="col-start-8 col-span-2 self-center flex justify-end" >
                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" className="text-sm bg-gray-500 dark:bg-neutral-600 dark:text-gray-200 w-fit h-fit rounded-lg p-1" viewBox="0 0 16 16" onClick={toggleMenu}>
